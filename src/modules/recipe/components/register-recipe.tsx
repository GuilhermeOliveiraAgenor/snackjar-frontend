  ...
  import { CreateRecipeFormData, CreateRecipeFormInput, createRecipeSchema } from "../schemas/create-recipe-schema";
  ...
  export default function RegisterRecipe() {
    ...
    >({
      ...
      defaultValues: {
        ...
        categoryId: "",
        recipeIngredient: [
          { ingredient: "", amount: "", unit: "" as MeasurementUnit }
        ],
    ...
    function addSteps() {
      ...
      const nextStep =
        currentSteps.length > 0
          ? currentSteps[currentSteps.length - 1].step + 1
          : 1;
                ...
                <FieldSet>
                  <FieldGroup>
                    <Field>
                      ...
                      <Input id="title" placeholder="Bolo de Cenoura"                 maxLength={50}
  {...register("title")} />
                    </Field>
                    ...
                    <Field>
                      ...
                      {errors.preparationTime && <span className="text-sm text-red-500">{errors.preparationTime.message}</span>}
